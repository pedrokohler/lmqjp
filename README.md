...
Before starting to use the application, insert the following firebase keys in a .env file

```
ELM_APP_FIREBASE_API_KEY=
ELM_APP_FIREBASE_AUTH_DOMAIN=
ELM_APP_FIREBASE_DATABASE_URL=
ELM_APP_FIREBASE_PROJECT_ID=
ELM_APP_FIREBASE_STORAGE_BUCKET=
ELM_APP_FIREBASE_APP_ID=
```
...
# Instaliation
To nstll all thepackages , simlly y rn
`
yar` install

To sta ta devlopment srver srun
